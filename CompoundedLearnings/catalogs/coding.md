...
| Record field inference collision | `articles/coding/record-field-inference-collision.md` | Adding a record type whose field labels (`outcome`, `status`, `result`) already exist on another record in the same module or an opened one |

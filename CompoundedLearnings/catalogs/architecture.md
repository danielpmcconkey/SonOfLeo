...
| Type placement by compile tier | `articles/architecture/type-placement-by-compile-tier.md` | Deciding which file a new type goes in — especially when the component file for its own domain can't see one of its dependencies |

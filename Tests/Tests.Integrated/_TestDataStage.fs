        ...
        let stageResult =
            result {
                ...
                let! assets1000, assets1000Id =
                    createTestAccountFromPrimitives "F-1000" "Assets" "Asset" lastYear None None None None envelope None
                ...
                let! updatedClosedBank =
                    closedBank1290 |> AccountDeactivation.deactivateAccount None envelope (Some twoMonthsAgo)

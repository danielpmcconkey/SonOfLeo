...
type AccountBalanceTests(fixture: TestDataFixture) =
    ...
    member _.``REQ-JE-3.6 fetchByAccountIdList returns correct debit and credit totals``() =
        withoutTransaction (fun tran ->
            ...
            let expectedDebits1 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran false id1 Debit
            let expectedCredits1 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran false id1 Credit
            let expectedDebits2 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran false id2 Debit
            let expectedCredits2 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran false id2 Credit
            let expectedBal1 = expectedCredits1 - expectedDebits1 // liability
            let expectedBal2 = expectedDebits2 - expectedCredits2 // expense
            let result = fetchByAccountIdList tran accountsList None
            match result with
            | Ok balances ->
    ...
    member _.``REQ-JE-3.6 REQ-JE-4.7 fetchByAccountIdList excludes voided entry amounts``() =
        withoutTransaction (fun tran ->
            ...
            let accountsList = [ id1; id2 ]
            let expectedDebits1 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran true id1 Debit
            let expectedCredits1 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran true id1 Credit
            let expectedDebits2 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran true id2 Debit
            let expectedCredits2 =
                fixture.Data.journalEntryLines |> sumJournalEntryLinesByAccountIdAndType tran true id2 Credit
            let expectedBal1 = expectedCredits1 - expectedDebits1 // liability
            let expectedBal2 = expectedDebits2 - expectedCredits2 // expense
            let result = fetchByAccountIdList tran accountsList None
            match result with

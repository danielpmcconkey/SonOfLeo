...
//     // =============================================================================
//     [<Fact>]
//     member _.``REQ-JE-3.2 fetchById returns a header whose entry date is in a closed fiscal period`` () =
...
//         | Error e -> Assert.Fail $"Fetching a JE header in a closed period must succeed: {AppError.toMessage e}"

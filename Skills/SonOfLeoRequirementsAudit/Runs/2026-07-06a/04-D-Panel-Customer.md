...
```json
{
  "file_path": "/media/dan/fdrive/ai-sandbox/workspace/SonOfLeo/Skills/SonOfLeoRequirementsAudit/Runs/2026-07-06a/panel-customer.md"
}
```
...
```json
{
  "command": "cd /media/dan/fdrive/ai-sandbox/workspace/SonOfLeo && grep -n \"audit skill\\|Update prompts\\|skill.*prompt\\|prompt.*update\\|skill.*improv\" Skills/SonOfLeoRequirementsAudit/Runs/2026-07-06a/action-items.md",
